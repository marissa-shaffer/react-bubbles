...
A token allows access to protected resources that require authentication.

- [ ] What steps can you take in your web apps to keep your data secure?

The steps that can be taken to keep data secure are creating tokens and a login with a payload of userneme and password. The tokens are stored on the client side using local storage or session storage. The credentials for the login help protect sensitive information.

- [ ] Describe how web servers work.

The user on the computer connects to the internet through the web, locates a server computer with a URL and domain name, and then retrieves the information and resources from that server.
